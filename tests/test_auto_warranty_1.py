...
test_file = "20231208-0112290.txt"
...
def test_primary_company(setup_general_1):
    assert "emulate auto" in setup_general_1['Primary Company'].lower(), f"Actual: {setup_general_1['Primary Company']}|"
...
def test_offer_close_date(setup_3):
    assert setup_3['Offer Close Date'] == '2023-11-21', f"Actual: {setup_3['Offer Close Date']}|"

def test_warranty(setup_3):
    assert "5" and "100" in setup_3['Warranty'].lower(), f"Actual: {setup_3['Warranty']}|"
