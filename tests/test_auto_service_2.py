...
def test_mailing_type(setup_general_1):
    assert setup_general_1['Mailing Type'] == 'Win Back', f"Actual: {setup_general_1['Mailing Type']}|"
...
def test_presorted(setup_general_1):
    assert setup_general_1['Presorted'] == 'N', f"Actual: {setup_general_1['Presorted']}|"
...
def test_offer_summary(setup_general_3):
    assert "save" or "discount" in setup_general_3['Offer Summary'].lower() and "tires" or "service" in setup_general_3['Offer Summary'].lower(), f"Actual: {setup_general_3['Offer Summary']}|"

def test_offer_close_date(setup_general_3):
    assert setup_general_3['Offer Close Date'] == 'December 16, 2023', f"Actual: {setup_general_3['Offer Close Date']}|"
